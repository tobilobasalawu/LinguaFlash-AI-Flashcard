    ...
    <section className="flex flex-col md:flex-row gap-24 md:gap-10 px-5 pt-[153px] lg:pt-[169px] pb-20 md:px-10">
      ...
      <div className="flex flex-col gap-6 ld:gap-10 w-full md:w-1/2">
        ...
        <div className="flex items-end gap-6 lg:gap-10">
          ...
          <button className="font-manrope font-bold -tracking-[.02em] text-base lg:text-lg !leading-none text-black pink-gradient rounded-xl lg:rounded-2xl py-4 px-6 lg:py-[18px] lg:px-9 hover:bg-none hover:bg-fuchsia-400 transition-colors duration-100">
            Get started
          </button>
        </div>
      </div>
