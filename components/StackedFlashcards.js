	...
	return (
		<div className="grid grid-cols-1 grid-rows-1 auto-rows-auto">
			...
			<div
                ...
                before:absolute before:z-50 before:grid before:inset-0 before:place-content-center before:text-center before:content-['Hola!'] before:font-dela-gothic-one 
                before:text-black before:tracking-[.02em] before:!leading-none before:text-[40px]"></div>
			<div
